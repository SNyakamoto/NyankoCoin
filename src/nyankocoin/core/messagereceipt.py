...
from nyankocoin.core.Message import Message
from nyankocoin.core.MessageRequest import MessageRequest
from nyankocoin.core.txs.CoinBase import CoinBase
from nyankocoin.generated import nyankocoinlegacy_pb2
from nyankocoin.generated.nyankocoinlegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        nyankocoinlegacy_pb2.LegacyMessage.VE: 'veData',
        nyankocoinlegacy_pb2.LegacyMessage.PL: 'plData',
        nyankocoinlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        nyankocoinlegacy_pb2.LegacyMessage.MR: 'mrData',
        nyankocoinlegacy_pb2.LegacyMessage.SFM: 'mrData',

        nyankocoinlegacy_pb2.LegacyMessage.BK: 'block',
        nyankocoinlegacy_pb2.LegacyMessage.FB: 'fbData',
        nyankocoinlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        nyankocoinlegacy_pb2.LegacyMessage.TX: 'txData',
        nyankocoinlegacy_pb2.LegacyMessage.MT: 'mtData',
        nyankocoinlegacy_pb2.LegacyMessage.TK: 'tkData',
        nyankocoinlegacy_pb2.LegacyMessage.TT: 'ttData',
        nyankocoinlegacy_pb2.LegacyMessage.LT: 'ltData',
        nyankocoinlegacy_pb2.LegacyMessage.SL: 'slData',

        nyankocoinlegacy_pb2.LegacyMessage.EPH: 'ephData',

        nyankocoinlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        nyankocoinlegacy_pb2.LegacyMessage.MC: 'mcData',
        nyankocoinlegacy_pb2.LegacyMessage.MS: 'msData',
        nyankocoinlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[nyankocoinlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = nyankocoinlegacy_pb2.LegacyMessage(**{'func_name': msg_type,

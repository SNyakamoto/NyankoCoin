...
class AddressState(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = nyankocoin_pb2.AddressState()
    ...
    def pbdata(self):
        ...
        :rtype: nyankocoin_pb2.AddressState
        """
        return self._data
    ...
    def add_lattice_pk(self, lattice_txn):
        lattice_pk = nyankocoin_pb2.LatticePK(txhash=lattice_txn.txhash,
    ...
    def get_address_state(state: State, address: bytes):
        try:
            ...
            pbdata = nyankocoin_pb2.AddressState()

...
from nyankocoin.core.config import DevConfig, user as user_config
...
class BlockHeader(object):
    def __init__(self, protobuf_blockheader=None):
        ...
        if protobuf_blockheader is None:
            self._data = nyankocoin_pb2.BlockHeader()
    ...
    def pbdata(self):
        ...
        :rtype: nyankocoin_pb2.BlockHeader
        """
        return self._data
    ...
    def from_json(json_data):
        pbdata = nyankocoin_pb2.BlockHeader()

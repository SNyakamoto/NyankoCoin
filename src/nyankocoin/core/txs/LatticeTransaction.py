...
from nyankocoin.generated.nyankocoin_pb2 import LatticePKMetadata
...
class LatticeTransaction(Transaction):
    ...
    def _validate_extended(self, state_container: StateContainer) -> bool:
        ...
        if len(self.pk1) > dev_config.lattice_pk1_max_length:
        ...
        if len(self.pk2) > dev_config.lattice_pk2_max_length:
        ...
        if len(self.pk3) > dev_config.lattice_pk3_max_length:

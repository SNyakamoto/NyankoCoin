...
from nyankocoin.core.BlockHeader import BlockHeader
from nyankocoin.crypto.misc import merkle_tx_hash
...
class Block(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = nyankocoin_pb2.Block()
    ...
    def get_block_number_mapping(state: State, block_number: int):
        try:
            ...
            block_number_mapping = nyankocoin_pb2.BlockNumberMapping()
